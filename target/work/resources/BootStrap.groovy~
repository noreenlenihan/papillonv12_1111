...
class BootStrap {
	...
	def shiroSecurityService
		...
		def init = { servletContext ->
			...
			def server1 = new Server(serverName: "server1", location: "UCD", floor: 1, rack: 2)
			server1.save()
			def server2 = new Server(serverName: "server2", location: "UCD", floor: 2, rack: 2)
			server2.save()
			def server3 = new Server(serverName: "server1", location: "AIB", floor: 1, rack: 2)
			server3.save()
			def server4 = new Server(serverName: "server2", location: "AIB", floor: 3, rack: 2)
			server4.save()
