...
class gsp_shiro_test_resultedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/result/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('set','g',34,['var':("entityName"),'value':(message(code: 'result.label', default: 'Result'))],-1)
printHtmlPart(10)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',83,['bean':(resultInstance),'var':("error")],3)
printHtmlPart(27)
})
invokeTag('hasErrors','g',85,['bean':(resultInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(28)
invokeTag('hiddenField','g',87,['name':("version"),'value':(resultInstance?.version)],-1)
printHtmlPart(29)
...
invokeTag('form','g',94,['url':([resource:resultInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1414557853000L
