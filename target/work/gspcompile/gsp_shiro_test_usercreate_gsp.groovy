...
class gsp_shiro_test_usercreate_gsp extends GroovyPage {
...
printHtmlPart(9)
invokeTag('set','g',32,['var':("entityName"),'value':(message(code: 'user.label', default: 'User'))],-1)
printHtmlPart(10)
createTagBody(2, {->
createTagBody(3, {->
...
printHtmlPart(14)
createTagBody(2, {->
invokeTag('message','g',69,['code':("default.list.label"),'args':([entityName])],-1)
})
invokeTag('link','g',69,['class':("list"),'action':("index")],2)
printHtmlPart(15)
invokeTag('message','g',73,['code':("default.create.label"),'args':([entityName])],-1)
printHtmlPart(16)
...
invokeTag('eachError','g',81,['bean':(userInstance),'var':("error")],3)
printHtmlPart(26)
})
invokeTag('hasErrors','g',83,['bean':(userInstance)],2)
printHtmlPart(19)
createTagBody(2, {->
printHtmlPart(27)
invokeTag('render','g',86,['template':("form")],-1)
printHtmlPart(28)
invokeTag('submitButton','g',89,['name':("create"),'class':("save"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',91,['url':([resource:userInstance, action:'save'])],2)
printHtmlPart(30)
})
...
public static final long LAST_MODIFIED = 1414559007000L
