...
class gsp_shiro_test_userindex_gsp extends GroovyPage {
...
printHtmlPart(20)
invokeTag('sortableColumn','g',83,['property':("username"),'title':(message(code: 'user.username.label', default: 'Username'))],-1)
printHtmlPart(21)
invokeTag('sortableColumn','g',85,['property':("passwordHash"),'title':(message(code: 'user.passwordHash.label', default: 'Password Hash'))],-1)
printHtmlPart(22)
loop:{
int i = 0
...
invokeTag('link','g',93,['action':("show"),'id':(userInstance.id)],3)
printHtmlPart(25)
expressionOut.print(fieldValue(bean: userInstance, field: "passwordHash"))
printHtmlPart(26)
i++
}
}
printHtmlPart(27)
invokeTag('paginate','g',102,['total':(userInstanceCount ?: 0)],-1)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1414559244000L
