...
class gsp_shiro_test_useredit_gsp extends GroovyPage {
...
printHtmlPart(16)
invokeTag('message','g',76,['code':("default.edit.label"),'args':([entityName])],-1)
printHtmlPart(17)
...
printHtmlPart(25)
invokeTag('message','g',83,['error':(error)],-1)
printHtmlPart(26)
})
invokeTag('eachError','g',84,['bean':(userInstance),'var':("error")],3)
printHtmlPart(27)
})
invokeTag('hasErrors','g',86,['bean':(userInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(28)
invokeTag('hiddenField','g',88,['name':("version"),'value':(userInstance?.version)],-1)
printHtmlPart(29)
invokeTag('render','g',90,['template':("form")],-1)
printHtmlPart(30)
invokeTag('actionSubmit','g',93,['class':("save"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(31)
})
invokeTag('form','g',95,['url':([resource:userInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1414559402000L
