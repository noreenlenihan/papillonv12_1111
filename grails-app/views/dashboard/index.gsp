    ...
    <div class="container-fluid">
		...
		<div class="btn-group">
		  ...
		  <ul class="dropdown-menu" style="width:500px;" role="menu">
		    ...
		    <li style="padding:10px;" onMouseOver="this.style.backgroundColor='#FFCACA'" onMouseOut="this.style.backgroundColor='white'">Budget exceeded by $${it[1]} on ${it[0]}</li>
		    <li class="divider"></li>
		    </g:each>
		  </ul>
		</div></li>
...
<div id="linechart"></div>
	...
	dailyAlerts: ${dailyAlertsData}
		...
		<tr>
                    <td>${it}</td>
                    <td>${totalDailyPower}</td>
                    <td>${totalDailyPowerCost}</td>
                    <td>${totalDailyCarbon}</td>
                    <td>n/a</td>
                </tr>
               </g:each>
